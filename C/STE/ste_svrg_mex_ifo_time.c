/*
 * ste_svrg_mex_ifo.c - STE for ordinal embedding with SVRG in MATLAB External Interfaces
*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	double relative_residual, eta, sum_residel, sum, *duration, *X_int, *X_new, *X_snapshot, *train, *test, *avg_grad, *stoch_grd, *snapshot_grd, *train_error, *test_error;
